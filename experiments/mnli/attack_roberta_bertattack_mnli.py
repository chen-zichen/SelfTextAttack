...
directory = 'repos/std_text_pgd_attack/checkpoints/roberta-large-mnli'
model = RobertaForSequenceClassification.from_pretrained(directory)
tokenizer = RobertaTokenizer.from_pretrained('repos/std_text_pgd_attack/checkpoints/roberta-large-mnli')
