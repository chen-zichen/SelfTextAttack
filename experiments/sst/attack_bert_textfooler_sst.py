...
def load_dataset_sst(path = 'repos/text_grad/sst-2/'):
...
directory = 'repos/TextAttack/checkpoints/bert-sst-at/batch/4'
model = BertForSequenceClassification.from_pretrained(directory)
tokenizer = BertTokenizer.from_pretrained('repos/TextAttack/checkpoints/bert-sst-at/batch/4')
